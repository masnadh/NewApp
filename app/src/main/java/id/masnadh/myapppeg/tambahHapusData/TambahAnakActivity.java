...
public class TambahAnakActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etNik = (EditText) findViewById(R.id.inp_nik_anak);
        etNama = (EditText) findViewById(R.id.inp_nama_anak);
        etTmp = (EditText) findViewById(R.id.inp_tmp_anak);
        etTgl = (EditText) findViewById(R.id.inp_tgl_anak);
        ...
        etPend = (EditText) findViewById(R.id.inp_pend_anak);
        etPek = (EditText) findViewById(R.id.inp_pek_anak);
        etStatus = (EditText) findViewById(R.id.inp_status_anak);
       // btnbatalPas = (Button) findViewById(R.id.btn_cancel_pend);
        btnsimpanPas = (Button) findViewById(R.id.btn_simpan_anak);
        pd = new ProgressDialog(TambahAnakActivity.this);
    ...
    private void updateData() {
        ...
        StringRequest updateReg = new StringRequest(Request.Method.POST, Server.URL_UPDATE_ANAK, new Response.Listener<String>() {
            @Override
            ...
            public void onErrorResponse(VolleyError error) {
                pd.cancel();
                Toast.makeText(TambahAnakActivity.this, "pesan : Gagal Insert Data", Toast.LENGTH_SHORT).show();
            }
        })
        {
            @Override
    ...
    private void simpanData() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Server.URL_INSERT_ANAK, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {
                    JSONObject jsonObject = new JSONObject(response);
                    ...
                    Toast.makeText(TambahAnakActivity.this, "pesan : " + jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
